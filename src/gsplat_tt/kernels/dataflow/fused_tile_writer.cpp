...
//
// FUSED_TILE writer (GSPLAT_TT_FUSED_TILE scaffold v1).
// Phase-1: pack SFPU keep tiles into resident cull_masks (same as writer_microblock_cull).
// Phase-2: also commit per-tile bf16 RGB into res_out in this kernel.
//
