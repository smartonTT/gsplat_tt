...
void kernel_main() {
    ...
    // SFPU binary inits (used for fp32-clean state updates in stages D1/D2/E).
    // Same playbook as project_means_cam_compute (tt-007): keeps state mutation
    // entirely on DEST in fp32 and avoids the SrcA/SrcB bf16 truncation that
    // capped PSNR at 39 dB in iter-12.
