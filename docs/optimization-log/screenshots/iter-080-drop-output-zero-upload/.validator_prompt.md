...
- iter_dir: /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload
- ref_dir: /Users/smarton/dev/gsplat_tt/benchmarks/reference
- renders: /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload/hero.png /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload/side.png /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload/top.png
...
- diff10: /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload/hero_diff10.png /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload/side_diff10.png /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload/top_diff10.png
- metrics: /Users/smarton/dev/gsplat_tt/docs/optimization-log/screenshots/iter-080-drop-output-zero-upload/metrics.json

Read the metrics JSON inline:
```json
{
  "iter_dir": "iter-080-drop-output-zero-upload",
  "class": "dispatch",
  "prev_best_kernel_ms": 24.7055,
  "psnr_per_view": {
    "hero": 16.715158010662318,
    "side": 9.360678066047894,
    "top": 8.310339657602716
  },
  "tile_structure_ratio_per_view": {
    "hero": 30.328232976593437,
    "side": 31.23560265388311,
    "top": 31.51362986654983
  },
  "kernel_ms_median": 24.48,
  "kernel_ms_p99": 29.30971,
  "per_view_median": {
    "hero": 24.48,
    "side": 23.632,
    "top": 29.305500000000002
  },
  "frame_count": 30,
  "stage_medians": {
    "total_ms": 113.62639350409154,
    "project_ms": 17.515636485768482,
    "tile_assign_ms": 7.3471740033710375,
    "sort_ms": 1.7995060043176636,
    "blend_ms": 84.53463249315973
  },
  "sub_medians": {
    "blend.daemon_rt": 58.0432589922566,
    "blend.daemon_rt.device_kernel": 24.48,
    "blend.daemon_rt.encode_ms": 13.3825,
    "blend.daemon_rt.io_load_ms": 2.268,
    "blend.daemon_rt.io_save_ms": 14.8255,
    "blend.load_npy": 1.3328140048542991,
    "blend.prep": 7.6283019880065694,
    "blend.prep.cov_inv": 0.4028865077998489,
    "blend.prep.gather": 6.442797515774146,
    "blend.prep.offsets": 0.04946900298818946,
    "blend.prep.px_py_grid": 0.0025550107238814235,
    "blend.prep.tile_origin": 0.6922540051164106,
    "blend.save_npy": 16.958657011855394,
    "project.cam_xform": 1.6656815132591873,
    "project.cov2d": 8.244182492489927,
    "project.cov3d": 4.56911300716456,
    "project.radii": 1.1050309985876083,
    "project.screen_xy": 0.33576700661797076,
    "sort.argsort": 1.0202365083387122,
    "sort.gather": 0.25856299907900393,
    "sort.keys": 0.3430425131227821,
    "sort.ranges": 0.18935349362436682,
    "tile_assign.bbox": 0.5127804761286825,
    "tile_assign.contrib_cull": 3.0116950074443594,
    "tile_assign.flat_ids": 1.9051949784625322,
    "tile_assign.repeat": 1.8566950020613149
  }
}```
