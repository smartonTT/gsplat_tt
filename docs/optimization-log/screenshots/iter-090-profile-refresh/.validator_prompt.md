...
- iter_dir: docs/optimization-log/screenshots/iter-090-profile-refresh
- ref_dir: /Users/smarton/dev/gsplat_tt/benchmarks/reference
- renders: docs/optimization-log/screenshots/iter-090-profile-refresh/hero.png docs/optimization-log/screenshots/iter-090-profile-refresh/side.png docs/optimization-log/screenshots/iter-090-profile-refresh/top.png
...
- diff10: docs/optimization-log/screenshots/iter-090-profile-refresh/hero_diff10.png docs/optimization-log/screenshots/iter-090-profile-refresh/side_diff10.png docs/optimization-log/screenshots/iter-090-profile-refresh/top_diff10.png
- metrics: docs/optimization-log/screenshots/iter-090-profile-refresh/metrics.json

Read the metrics JSON inline:
```json
{
  "iter_dir": "iter-090-profile-refresh",
  "class": "dispatch",
  "prev_best_kernel_ms": 24.474,
  "psnr_per_view": {
    "hero": 39.368038413011824,
    "side": 40.949644684083964,
    "top": 38.574060625222735
  },
  "tile_structure_ratio_per_view": {
    "hero": 17.10734728220348,
    "side": 17.29181297057425,
    "top": 18.132160521349224
  },
  "kernel_ms_median": 24.572000000000003,
  "kernel_ms_p99": 29.2871,
  "per_view_median": {
    "hero": 24.572000000000003,
    "side": 23.747,
    "top": 29.235500000000002
  },
  "frame_count": 30,
  "stage_medians": {
    "total_ms": 109.2772164993221,
    "project_ms": 17.981642013182864,
    "tile_assign_ms": 7.437387990648858,
    "sort_ms": 1.9537939951987937,
    "blend_ms": 80.05947349010967
  },
  "sub_medians": {
    "blend.daemon_rt": 54.33330549567472,
    "blend.daemon_rt.device_kernel": 24.572000000000003,
    "blend.daemon_rt.dispatch_ms": 10.918,
    "blend.daemon_rt.encode_ms": 2.143,
    "blend.daemon_rt.io_load_ms": 2.2685,
    "blend.daemon_rt.io_save_ms": 12.536,
    "blend.daemon_rt.readback_ms": 0.4545,
    "blend.daemon_rt.upload_ms": 12.9025,
    "blend.load_npy": 1.1814805038738996,
    "blend.prep": 7.601567500387318,
    "blend.prep.cov_inv": 0.43998150795232505,
    "blend.prep.gather": 6.400497019058093,
    "blend.prep.offsets": 0.048929505283012986,
    "blend.prep.px_py_grid": 0.0026600027922540903,
    "blend.prep.tile_origin": 0.6961144972592592,
    "blend.save_npy": 16.755431992351077,
    "project.cam_xform": 1.6753464879002422,
    "project.cov2d": 8.372755997697823,
    "project.cov3d": 4.631307005183771,
    "project.radii": 1.2216199975227937,
    "project.screen_xy": 0.34300200059078634,
    "sort.argsort": 1.1115559900645167,
    "sort.gather": 0.2499879919923842,
    "sort.keys": 0.36808650474995375,
    "sort.ranges": 0.18516300769988447,
    "tile_assign.bbox": 0.5096954992040992,
    "tile_assign.contrib_cull": 3.092988990829326,
    "tile_assign.flat_ids": 1.7866999987745658,
    "tile_assign.repeat": 1.8991240067407489
  },
  "tracy_zones": []
}```
