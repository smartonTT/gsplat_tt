...
// Shared SFPU cull helpers (box ramps, mask buffer sizing). Production cull is
// tile_l1_cull below — per-subchunk masks on loaded PACK2, not global gid gather.
namespace cull {
...
// MUST match perm() in writer_tile_l1_mask.cpp exactly.
...
// Tile-local L1 cull: SFPU masks on each loaded subchunk (PACK2 in L1).
